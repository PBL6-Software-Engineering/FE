...
export class HistoryLostConnectService {
  // Define API
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/history-lost-connects')
  ...
  add(data: any): Observable<any> {
    return this.http
      .post<any>(
        this.apiURL + '/history-lost-connects',
        JSON.stringify(data),
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  update(id: any, data: any): Observable<any> {
    return this.http
      .put<any>(
        this.apiURL + '/history-lost-connects/' + id,
        JSON.stringify(data),
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/history-lost-connects/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(
        `${this.apiURL}/history-lost-connects/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/history-lost-connects/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(page: number, limit: number, filter: any): Observable<any> {
    let url =
      this.apiURL + '/history-lost-connects/paginate?page=' + page + '&limit=' + limit;

    // add condition filter
    if (filter != '') {
      url =
        this.apiURL +
        '/history-lost-connects/paginate?page=' +
        page +
        '&limit=' +
        limit +
        filter;
