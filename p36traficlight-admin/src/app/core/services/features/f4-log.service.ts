...
export class LogService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/logs/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(
    ...
    let url = `${this.apiURL}/logs/paginate?page=${params.page}&limit=${params.limit}&populate=${params.populate}${params.filter}`;
