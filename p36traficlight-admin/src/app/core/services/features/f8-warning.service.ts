...
export class WarningService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/warnings/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/warnings/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/warnings/paginate?page=${params.page}&limit=${params.limit}&populate=${params.populate}&${params.filter}`;
