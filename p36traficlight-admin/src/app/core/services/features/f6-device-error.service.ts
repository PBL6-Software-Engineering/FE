...
export class DeviceErrorService {
  // Define API
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/device-errors')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/device-errors/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(
        `${this.apiURL}/device-errors/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/device-errors/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(
    ...
    let url = `${this.apiURL}/device-errors/paginate?page=${params.page}&limit=${params.limit}&populate=${params.populate}${params.filter}`;
  ...
  findOneByCode(code: any) {
    return this.http
      .get(this.apiURL + '/device-errors/findOneByCode/' + code)
      .pipe(retry(1), catchError(this.handleError));
  }
}
