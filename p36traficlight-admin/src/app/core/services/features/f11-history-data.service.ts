...
export class HistoryDataService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/history-datas')
   ...
   * @returns
   */
  findByIdDevice(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/history-datas/findByIdDevice?idDevice=' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/history-datas/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(
        `${this.apiURL}/history-datas/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/history-datas/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(page: number, limit: number, filter: any): Observable<any> {
    let url =
      this.apiURL + '/history-datas/paginate?page=' + page + '&limit=' + limit;

    // add condition filter
    if (filter != '') {
      url =
        this.apiURL +
        '/history-datas/paginate?page=' +
        page +
        '&limit=' +
        limit +
        filter;
