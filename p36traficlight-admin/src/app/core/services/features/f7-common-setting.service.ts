...
export class CommonSettingService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/common-settings')
  ...
  update(id: any, data: any): Observable<any> {
    return this.http
      .put<any>(
        this.apiURL + '/common-settings/' + id,
        JSON.stringify(data),
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/common-settings/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(
        `${this.apiURL}/common-settings/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/common-settings/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(page: number, limit: number, filter: any): Observable<any> {
    let url =
      this.apiURL + '/common-settings/paginate?page=' + page + '&limit=' + limit;

    // add condition filter
    if (filter != '') {
      url =
        this.apiURL +
        '/common-settings/paginate?page=' +
        page +
        '&limit=' +
        limit +
        filter;
