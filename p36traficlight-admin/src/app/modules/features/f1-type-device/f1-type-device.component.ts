...
import {TypeDeviceService} from "../../../core/services/features/f1-type-device.service";

@Component({
  selector: 'app-f1-type-device',
  templateUrl: './f1-type-device.component.html',
  styleUrls: ['./f1-type-device.component.scss'],
})
export class F1TypeDeviceComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
