...
@Component({
  selector: 'app-f9-accounts-add',
  templateUrl: './f9-accounts-add.component.html',
  styleUrls: ['./f9-accounts-add.component.scss'],
})
export class F9AccountsAddComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
  ...
  onAddNewBtnClick() {
    ...
    if (this.inputUserInfo.role === this.roleEnum.admin1x) {
      ...
      delete this.inputUserInfo.idProvince;
    }
