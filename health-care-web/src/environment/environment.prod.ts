...
export const environment = {
  ...
  appPreviewChangelogUrl:
    'https://preview.keenthemes.com/html/metronic/docs/index/changelog',
  firebaseConfig: {
    apiKey: 'AIzaSyDKAzBDHlP6-ft_ROGZSULqiIRVyLCzzsY',
    authDomain: 'p36traficlights.firebaseapp.com',
    projectId: 'p36traficlights',
    storageBucket: 'p36traficlights.appspot.com',
    messagingSenderId: '289450013814',
    appId: '1:289450013814:web:bc1902624eaf24ca875b57',
    measurementId: 'G-DLWWYJ0RDK',
  },
  appDemos: {
    demo1: {
      title: 'Demo 1',
