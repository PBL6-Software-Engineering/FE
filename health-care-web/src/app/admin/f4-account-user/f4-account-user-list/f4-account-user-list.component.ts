...
@Component({
  selector: 'app-f4-account-user-list',
  templateUrl: './f4-account-user-list.component.html',
  styleUrls: ['./f4-account-user-list.component.scss'],
})
export class F4AccountUserListComponent implements OnInit, OnDestroy {
  // subscription
        ...
        .subscribe({
          next: () => {
            if (!this.itemSelected.is_accept) {
              this.toastr.success('Khoá người dùng thành công!');
            } else {
              this.toastr.success('Mở khoá người dùng thành công!');
            }
