...
@Component({
  selector: 'app-f9-working-time',
  templateUrl: './f9-working-time.component.html',
  styleUrls: ['./f9-working-time.component.scss'],
})
export class F9WorkingTimeComponent implements OnInit {
  isSaving = false;
  copyFrom = 'monday';
  pasteTo = 'all';
  days = [
